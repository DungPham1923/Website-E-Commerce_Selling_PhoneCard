...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <title>The Card Shop - Quản lý đánh giá</title>
        ...
        <%
            ...
            List<Comment> dataComment = (List<Comment>) request.getAttribute("list");
                                                ...
                                                <div class="table_row">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th style="text-align: center; padding: 14px 15px">Stt</th>
                                                                    <!--<th style="text-align: center; padding: 14px 10px">Khách hàng</th>-->
                                                                    <th style="text-align: center; padding: 14px 0px">Sản Phẩm</th>
                                                                    <th style="text-align: center; padding: 14px 0px">Tiêu đề</th>
                                                                    <th style="text-align: center; padding: 14px 0px">Nội dung</th>
                                                                    <th style="text-align: center; padding: 14px 0px">Ngày</th>
                                                                    <th style="text-align: center; padding: 14px 15px">Thao tác</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <% for(int i=0; i < dataComment.size(); i++) { %>
                                                                <% if(dataComment.get(i).isIsDelete() == true ) { %>
                                                                <tr>
                                                                    <td style="text-align: center; padding: 12px 15px"><%=i+1%></td>
                                                                    <!-- <td style="width: 120px; text-align: center; padding: 12px 10px"><%=dataComment.get(i).getUser().getID()%></td> -->
                                                                    <td style="text-align: center; padding: 12px 0px"><%=dataComment.get(i).getProductCategories().getName() %></td>
                                                                    <td style="padding: 12px 10px"><%=dataComment.get(i).getTitle() %></td>
                                                                    <td style="width: 350px; padding: 12px 0px"><%=dataComment.get(i).getMessage() %></td>
                                                                    <td style="text-align: center; padding: 12px 5px"><%=dataComment.get(i).getCreatedAt() %></td>
                                                                    <td style="padding: 7px 15px"></td>
                                                                </tr>
                                                                <% }else{ %>
                                                                <tr>
                                                                    <td style="text-align: center; padding: 12px 15px"><%=i+1%></td>
                                                                    <!-- <td style="width: 120px; text-align: center; padding: 12px 10px"><%=dataComment.get(i).getUser().getID()%></td> -->
                                                                    <td style="text-align: center; padding: 12px 0px"><%=dataComment.get(i).getProductCategories().getName() %></td>
                                                                    <td style="padding: 12px 30px"><%=dataComment.get(i).getTitle() %></td>
                                                                    <td style="width: 350px; padding: 12px 5px"><%=dataComment.get(i).getMessage() %></td>
                                                                    <td style="text-align: center; padding: 12px 5px"><%=dataComment.get(i).getCreatedAt() %></td>
                                                                    <td style="padding: 7px 15px">
                                                                        <a onclick="replyFeedback(<%=dataComment.get(i).getCommentID() %>)" class="btn btn-info" style="color: white;display: inline-block;" >Phản hồi</a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                                <%}%>
    ...
    <script>
                                function replyFeedback(idorderDetail) {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            const url = "replyfeedback?id=" + idorderDetail + "&reason=" + encodeURIComponent(reason);
